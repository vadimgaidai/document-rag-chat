...
export default tseslint.config(
  {
    ignores: [
      ...
      ".tanstack",
      ".claude",
      // Generated by TanStack Router; regenerated on every dev/build run.
      "src/routeTree.gen.ts",
      // Compiled by Paraglide from `messages/`; regenerated by `pnpm messages`.
      "src/paraglide",
    ],
  },

  // ---------------------------------------------------------------------------
  // Rules shared by every TypeScript file. No globals here — each environment
  // block below declares its own.
  // ---------------------------------------------------------------------------
  {
    files: ["**/*.{ts,tsx}"],
    extends: [
  ...
  // ---------------------------------------------------------------------------
  // Universal code: rendered on the server, hydrated in the browser.
  // ---------------------------------------------------------------------------
  {
  ...
  // ---------------------------------------------------------------------------
  {
    files: ["src/server.ts", "src/server/**/*.ts", "src/workers/**/*.ts", "**/*.server.{ts,tsx}"],
  ...
  // ---------------------------------------------------------------------------
  // shadcn/ui components are generated by the CLI; they are re-generated, not
  // hand-maintained, so house style rules do not apply to them.
  // ---------------------------------------------------------------------------
  {
...

  {
    ...
    rules: {
      // `Register` is TanStack Router's declaration-merging interface; its name
      // is fixed by the framework, so the I-prefix convention cannot apply.
      "@typescript-eslint/naming-convention": "off",
    },
  },
